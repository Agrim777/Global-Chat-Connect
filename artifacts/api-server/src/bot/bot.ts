...
async function sendEbook(chatId: number) {
  await bot.sendMessage(chatId, "📘 <b>How to Make a Bot and Earn</b>\n\nLearn how to build useful bots and explore practical ways to create earning opportunities online. Results depend on your skills, effort, and market — no income is guaranteed.", {
    parse_mode: "HTML",
    disable_web_page_preview: false,
